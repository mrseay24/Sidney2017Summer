...
/**
 * Created by sidneyseay on 6/28/17.
 */
...
public class AnimatorActivity extends BaseActivity {
    ...
    public void color(){
        ObjectAnimator animator = ObjectAnimator.ofInt(tv, "BackgroundColor", 0xffff00ff, 0xffffff00);
    ...
    @BindView(R.id.activity_animator_tv)
    TextView tv;
    ...
    private ValueAnimator doAnimatorListener(){
        ...
        animator.addListener(new Animator.AnimatorListener(){
            ...
            public void onAnimationStart(Animator animation){
                shortToast("Started");
                UtilLog.d("Sidney", "animation start");
            }
            @Override
            public void onAnimationEnd(Animator animation){
                shortToast("End");
                UtilLog.d("Sidney", "animation end");
            }
            @Override
            public void onAnimationCancel(Animator animation){
                shortToast("Cancel");
                UtilLog.d("Sidney", "animation cancel");
            }
            @Override
            public void onAnimationRepeat(Animator animation){
                shortToast("Repeat");
                UtilLog.d("Sidney", "animation repeat");
            }
        });
        animator.setRepeatMode(ValueAnimator.REVERSE);
        animator.setRepeatCount(2);
